...
export const fileApi = {
  ...
  export: (ids) => request.post('/file/export', { ids }, { responseType: 'blob' }),
  import: (formData) => request.post('/file/import', formData, { headers: { 'Content-Type': 'multipart/form-data' } }),
};
...
export const templateApi = {
  ...
  export: (ids) => request.post('/template/export', { ids }, { responseType: 'blob' }),
  import: (formData) => request.post('/template/import', formData, { headers: { 'Content-Type': 'multipart/form-data' } }),
};
...
export const processApi = {
  ...
  export: (ids) => request.post('/process/export', { ids }, { responseType: 'blob' }),
  import: (formData) => request.post('/process/import', formData, { headers: { 'Content-Type': 'multipart/form-data' } }),
};
...
export const sealApi = {
  ...
  export: (ids) => request.post('/seal/export', { ids }, { responseType: 'blob' }),
  import: (formData) => request.post('/seal/import', formData, { headers: { 'Content-Type': 'multipart/form-data' } }),
};
...
export const supplierApi = {
  ...
  export: (ids) => request.post('/supplier/export', { ids }, { responseType: 'blob' }),
  import: (formData) => request.post('/supplier/import', formData, { headers: { 'Content-Type': 'multipart/form-data' } }),
};
...
export const certificateApi = {
  ...
  export: (ids) => request.post('/certificate/export', { ids }, { responseType: 'blob' }),
  import: (formData) => request.post('/certificate/import', formData, { headers: { 'Content-Type': 'multipart/form-data' } }),
};
...
export const auditLogApi = {
  ...
  create: (data) => request.post('/audit-log/create', data),
  update: (data) => request.post('/audit-log/update', data),
  delete: (id) => request.post('/audit-log/delete', { id }),
  batchDelete: (ids) => request.post('/audit-log/batchDelete', { ids }),
  batchEnable: (ids) => request.post('/audit-log/batchEnable', { ids }),
  batchDisable: (ids) => request.post('/audit-log/batchDisable', { ids }),
  export: (ids) => request.post('/audit-log/export', { ids }, { responseType: 'blob' }),
  import: (formData) => request.post('/audit-log/import', formData, { headers: { 'Content-Type': 'multipart/form-data' } }),
};
