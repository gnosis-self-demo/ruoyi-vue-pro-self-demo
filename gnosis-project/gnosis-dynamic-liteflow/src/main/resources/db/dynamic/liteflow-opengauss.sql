...
COMMENT ON COLUMN liteflow_sys_rule.rule_type IS '规则类型';
...
COMMENT ON COLUMN liteflow_sys_method_intercept.method_signature IS '方法签名';
...
COMMENT ON COLUMN liteflow_sys_rule_history.operation_type IS '操作类型';
